...
/**
 * Utilidad para dibujar un botón con 3 estados gráficos (normal, rollover,
 * click) usando ImGui.
 * Permite centralizar la lógica visual y simplificar el código de los
 * formularios.
 */
public class ImageButton3State {
    ...
    public boolean render() {
        return render(this.x, this.y);
    }

    /**
     * Dibuja el botón en la posición especificada, ignorando la posición almacenada
     * en el constructor.
     * 
     * @param x Posición X
     * @param y Posición Y
    ...
    public boolean render(int x, int y) {
        ...
        // si esta en estado de clickeo y suelto el click izq, se realiza la accion del
        // boton.
        if (clicked) {
