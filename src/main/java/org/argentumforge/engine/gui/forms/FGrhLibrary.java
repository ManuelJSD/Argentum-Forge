...
public class FGrhLibrary extends Form {
    ...
    public void render() {
        ...
        if (ImGui.begin(I18n.INSTANCE.get("grhlib.manageTitle"), pOpen,
            ...
            if (ImGui.beginTable("LibrarySplit", 2, ImGuiTableFlags.Resizable | ImGuiTableFlags.BordersInnerV)) {
                ImGui.tableSetupColumn("CategoriesColumn", ImGuiTableColumnFlags.WidthFixed, 250);
                ImGui.tableSetupColumn("RecordsColumn", ImGuiTableColumnFlags.WidthStretch);
