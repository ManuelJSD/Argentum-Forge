...
public class PerlinNoise {
    ...
    private static final int[] P_BASE = {
    ...
    public PerlinNoise(long seed) {
        ...
        // Shuffle base permutation with seed
        int[] p = P_BASE.clone();
    ...
    /**
     * Get noise value at coordinates (range: -1 to 1)
     */
    ...
    /**
     * Octave noise - combines multiple frequencies for natural variation
     */
